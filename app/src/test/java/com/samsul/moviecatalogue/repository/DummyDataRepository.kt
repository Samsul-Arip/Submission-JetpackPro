...
class DummyDataRepository constructor(
    ...
    override fun getMovieAsPaged(sort: String): LiveData<Resource<PagedList<DataLocalMovie>>> {
        return object :
            NetworkBoundResource<PagedList<DataLocalMovie>, List<DataMovie>>(executors) {
    ...
    override fun getTvShowAsPaged(sort: String): LiveData<Resource<PagedList<DataLocalTvShow>>> {
        ...
        return object :
            NetworkBoundResource<PagedList<DataLocalTvShow>, List<DataTvShow>>(executors) {
